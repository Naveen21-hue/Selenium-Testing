...
public class WaitMethods extends TestCode {
	 ...
	 * @return NA
	 */
	public static void wait_until_aler_present(String uernameText)
	{
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(20));
		wait.until(ExpectedConditions.urlContains(uernameText));
	}
